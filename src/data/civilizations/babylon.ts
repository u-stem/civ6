...
export const babylon = {
  ...
  ability: {
    name: "エヌマ・アヌ・エンリル",
    description:
      "ユーレカ(技術ブースト)を獲得すると、その技術を前提技術なしで即座に完全解禁する。代償として1ターンあたりの科学産出が50%減少する。霊感(社会制度ブースト)と文化による社会制度の進行は通常どおりのため、文化路線とは相性が良い。",
  },
  leaders: [
    {
      id: "hammurabi",
  ...
  uniqueUnits: [
    {
      name: "サブム・キビットゥム",
      description:
        "古代の近接ユニット(他ユニットを置換しない)。戦闘力17(戦士より3低い)、移動力3・視界3。重騎兵・軽騎兵級ユニットに対して戦闘力+17。早期の偵察と対騎兵防衛に優れる。",
    },
  ],
